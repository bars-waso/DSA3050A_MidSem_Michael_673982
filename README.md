...
* Created Total Sales custom column
* Created Delivery Days custom column
* Created Sales Category conditional column
* Extracted Year, Month, Quarter, and Day from Sale_Date
* Filtered rows using Quantity Sold and Price
...
* Column Chart (Region vs Total Revenue)
...
3. Devices with 8GB and 12GB RAM showed the highest demand, suggesting customer preference for mid-range specifications.
